...
// const alchemyApiKey = process.env.API_URL;
...
//         privateKey,
//         `https://eth-sepolia.g.alchemy.com/v2/HNvLk31-XUomIQix3VRX0Di0qRnVFaM8}`
//       ),
...
module.exports = {
  ...
  compilers: {
    solc: {
      version: "0.8.0",  // Specify the version of the Solidity compiler
      settings: {
        optimizer: {
          enabled: true,
          runs: 1000
